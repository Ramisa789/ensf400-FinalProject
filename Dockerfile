        ...
        stage('Verify Docker Installation') {
            steps {
                script {
                    ...
                    if (!dockerVersion) {
                        error "Docker is not installed or not available in this Jenkins environment."
                    }
        ...
        stage('Build Container') {
            steps {
                script {
                    ...
                    if (dockerStatus != 0) {
                        error "Docker is not running. Ensure Docker is installed and running on the Jenkins server."
                    }
